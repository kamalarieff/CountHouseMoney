...
public class ACMunicipalitiesAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private ArrayList<ACMunicipality> municipalities;
    private Context context;

    public ACMunicipalitiesAdapter(Context tmpContext, ArrayList<ACMunicipality> municipalities) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ACMunicipality municipality = municipalities.get(position);
        if (municipality != null) {
            holder.subject.setText(municipality.getName());
        }
        return convertView;
    }

    public void addMunicipalities(ArrayList<ACMunicipality> municipalities) {
        this.municipalities = municipalities;
